...
<body class="easyui-layout" data-options="border:false">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var url = '${basePath}organization/get_list.json';
            var fcols = [
                { field: 'id', title: 'id', hidden: true },
                { field: 'no', title: '机构编号', width: 100 }
            ];
            var cols = [
        ...
        function add() {
            var title = '添加组织机构';
            var url = '${basePath}organization/add_page.htm';
        ...
        function del() {
            ...
            var purl = '${basePath}organization/del.json';
            parent.$.messager.confirm("询问", "您是否要删除当前组织？删除当前资源会连同子组织一起删除!", function(r) {
                if(r){
                    var param = {};
                    param.no = rows[0].no;
